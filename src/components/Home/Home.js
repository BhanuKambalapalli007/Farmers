  ...
  return (
    <div className="container-background">
      <nav className="navbar sticky-top navbar-expand-lg navbar-light navstyle">
        ...
        <button
          className="navbar-toggler projectname"
          type="button"
        ...
        >
          <span className="navbar-toggler-icon projectname"></span>
        </button>
        <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
          <div className="navbar-nav">
          <a className="nav-elements" href="components.html">
              <Link to='/'>Home</Link>
            </a>
            <a className="nav-elements" href="#">
              <Link to='/Products'>Products</Link>
            </a>
            <a className="nav-elements" href="#">
              Profile
            </a>
            <button onClick={handleLogout}><a className="nav-elements" href="#">
              Logout
            </a></button>
          </div>
        </div>
      </nav>
      <div className="carousel-container d-flex flex-column justify-content-center">
      <MyCarousel/>
      </div>
    ...
    <p class="text">Our website highly empowers farmers and will maximize their earnings.We all know the difficulties in cultivating crops and exporting them, by leveraging our tools and resources, farmers can optimize their operations, 
      ...
      This direct interaction fosters transparency and trust between producers and consumers.
    </p>
  </div>
